...
class JarvisUI:
    ...
    def _build_social_bar(self):
        ...
        name_lbl.bind("<Button-1>", _open("https://github.com/aliyhacker"))

        self._icon_ig = _load_icon("github-logo.png")
        self._icon_yt = _load_icon("discord-logo.png")

        if self._icon_ig:
            ig_lbl = tk.Label(bar, image=self._icon_ig, bg=C_BG, cursor="hand2")
            ig_lbl.pack(side="left", padx=4)
            ig_lbl.bind("<Button-1>", _open("https://github.com/aliyhacker"))

        if self._icon_yt:
            yt_lbl = tk.Label(bar, image=self._icon_yt, bg=C_BG, cursor="hand2")
            yt_lbl.pack(side="left", padx=4)
            yt_lbl.bind("<Button-1>", _open("https://discord.com/users/1525886025438593117"))
